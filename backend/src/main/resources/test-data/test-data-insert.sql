...
insert into users(user_id, email, name, daily_study_words) values (1, 'testuser1@fortest.email', 'testuser1', 30);
insert into users(user_id, email, name, daily_study_words) values (2, 'testuser2@fortest.email', 'testuser2', 30);
